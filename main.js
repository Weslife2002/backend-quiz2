...
let findStartEndOfMonth = (inputDate, tzString) => {
  ...
  startDate = new Date((new Date(Date.UTC(date.getUTCFullYear(), date.getUTCMonth(), 1))).getTime());
...
console.log(findLastWeekPeriod(new Date("2022-10-23T16:00:00Z"), 'Asia/Ho_Chi_Minh'))